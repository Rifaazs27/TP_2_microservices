...
--> Le rate limiting utilise une variable en mémoire locale dans le Gateway et si on a plusieurs instances chaque instance a son propre compteur et l'utilisateur peut contourner la limite globale.
